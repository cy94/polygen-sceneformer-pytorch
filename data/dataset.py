...
def create_dataset(source="SUNCG", dest="main", num_houses=-1, batch_size=1000):
    """
    ...
    """
    data_dir = utils_wang.get_data_root_dir()
    ...
    if source == "SUNCG":
        house_dir = f"{data_dir}/suncg/house"
            ...
            for room in rooms:
                ...
                for node in nodes:
                    if hasattr(node, "parent"):
                        ...
                        alignment_matrix = DatasetToJSON.object_data.get_alignment_matrix(
                            node.modelId
                        )
